...
Forwarding   https://abstract-huntsman-unranked.ngrok-free.dev -> http://localhost:3000

Comparte esa URL con los demás. No cierres ninguna de las dos terminales mientras dure la sesión.

> ⚠️ En el plan gratuito de ngrok la URL cambia cada vez que reinicias. Si la URL cambia, deberás agregarla nuevamente en Firebase Authorized Domains.
---
